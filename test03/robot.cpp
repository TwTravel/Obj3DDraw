...
main(int argc, char **argv)
{
  ...
  StlShape *StlPart01= new StlShape; StlPart01 ->nodename = "ur_shape";
  StlPart01 ->LoadStl("upperarm.stl");
  ...
  Transformation *Stl01Trans  =new Transformation; Stl01Trans  ->nodename="Robot_TF_HeadTrans  "; 
  Stl01Trans->SetValue(TRANSLATION, 0, 0, -1.4, 0);
  StlPart01->SetTransform(Stl01Trans);
