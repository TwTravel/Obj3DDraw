...
main(int argc, char **argv)
{
  ...
  /* <body name="ur10:base_link"      pos="0 0        0.435" childclass="ur10:arm">
   ...
   StlPart01->AddChild(StlPart02);
   StlPart02->AddChild(StlPart03);
   StlPart03->AddChild(StlPart04);
   StlPart04->AddChild(StlPart05);
   StlPart05->AddChild(StlPart06);
   StlPart06->AddChild(StlPart07);
